...
const ReservationForm = () => {
  return (
    <div className='bg-green-700 p-6 rounded-lg text-white'>
        ...
        <div className='mt-[2rem]'>
            ...
            <div className='mt-[2rem] w-[80%] text-center mx-auto'>
                <button className='px-3 py-8 rounded-lg mb-[3rem] text-[16px] w-full bg-blue-950 transition-all duration-200 hover:bg-red-600 text-white'>Book Now</button>
            </div>
        </div>
    </div>
  )
