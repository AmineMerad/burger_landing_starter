...
const BurgerCard = ({title , image , reviews ,  price} : Props ) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3'>
        ...
        <p className='mt-[0.5rem] text-black text-opacity-70'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum sint porro natus aperiam tempore. Id dignissimos aliquid repudiandae, tenetur delectus unde corporis labore culpa sequi.</p>
        <div className='flex mt-[1.4rem] items-center justify-between'>
            <h1 className='text-[25px] font-bold text-red-600 '>{price}</h1>
            <button className='px-4 py-2 hover:bg-green-700 transition-all duration-200 bg-orange-500 flex
